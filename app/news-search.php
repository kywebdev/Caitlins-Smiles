...
<html lang="en">
    <head>
        <title>Search Results | Caitlin's Smiles</title>
        <?php include('includes/meta.php'); ?>
        <?php include('includes/favicon.php'); ?>
        <?php include('includes/styles.php'); ?>
    </head>
    <body class="news news-search">
					...
					<div class="row">
						<div class="col-lg-8 news-articles">
							<div class="search-results-info">
								<a href="news.php" class="orange-btn back-btn">Back</a>
								<h2>showing search results for <br /><em>"volunteer"</em></h2>
							</div>
							<article>
							...
							<div class="load-more">
								<button class="orange-btn">Load More<span> Search Results</span></button>
							</div>
						</div>
